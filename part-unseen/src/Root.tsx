...
export const Root: React.FC = () => (
  <>
    ...
    <Composition id="DayWide" component={DayEleven} durationInFrames={600} fps={30} width={1920} height={1080} />
    <Composition id="DayTall" component={DayEleven} durationInFrames={600} fps={30} width={1080} height={1350} />
  </>
);
